...
namespace Softellect.Migrations.WorkerNodeService.Migrations
{
    ...
    partial class WorkerNodeDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Softellect.Migrations.WorkerNodeService.NotificationType", b =>
                {
            ...
            modelBuilder.Entity("Softellect.Migrations.WorkerNodeService.RunQueueStatus", b =>
                {
                    b.Property<int>("RunQueueStatusId")
                        .HasColumnType("int")
                        .HasColumnName("runQueueStatusId");
            ...
            modelBuilder.Entity("Softellect.Migrations.WorkerNodeService.Setting", b =>
                {
            ...
            modelBuilder.Entity("Softellect.Migrations.WorkerNodeService.ModelData", b =>
                {
                    b.HasOne("Softellect.Migrations.WorkerNodeService.RunQueue", "RunQueue")
                        .WithOne("ModelData")
                        .HasForeignKey("Softellect.Migrations.WorkerNodeService.ModelData", "RunQueueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Softellect.Migrations.WorkerNodeService.RunQueue", b =>
                {
                    b.HasOne("Softellect.Migrations.WorkerNodeService.NotificationType", "NotificationType")
                        .WithMany("RunQueues")
                        .HasForeignKey("NotificationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Softellect.Migrations.WorkerNodeService.RunQueueStatus", "RunQueueStatus")
                        .WithMany("RunQueues")
