...
module CommandLine =
    ...
    //let getServiceSettingsImpl b v p =
    //    let load() = loadMsgServiceSettings v
    //    let tryGetSave() = tryGetSaveSettings p
    //    getMsgServiceInfo (load, tryGetSave) b
    ...
    //    let i = loadMsgServiceSettings v
    ...
    //let getMessagingServiceData<'D> logger (v : MessagingDataVersion) : WcfServiceData<MessagingServiceData<'D>> =
    //    let proxy : MessagingServiceProxy<'D> = createMessagingServiceProxy getMessagingConnectionString v

    //    let serviceData =
    //        {
    //            messagingServiceAccessInfo = loadMessagingServiceAccessInfo v
    //            messagingServiceProxy = proxy
    //        }
